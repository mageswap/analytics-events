 ...
 */
export var InterfaceSectionName;
...
})(InterfaceModalName || (InterfaceModalName = {}));
/**
 * Known element names for analytics purposes.
 * Use to identify low-level components given a TraceContext
 */
export var InterfaceElementName;
(function (InterfaceElementName) {
    ...
    InterfaceElementName["MAGESWAP_WALLET_BANNER_DOWNLOAD_BUTTON"] = "mageswap-wallet-banner-download-button";
    InterfaceElementName["MAGESWAP_WALLET_CONNECTOR"] = "mageswap-wallet-connector";
    InterfaceElementName["MAGESWAP_WALLET_MODAL_DOWNLOAD_BUTTON"] = "mageswap-wallet-modal-download-button";
